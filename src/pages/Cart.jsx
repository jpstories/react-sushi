...
import { clearCart, removeGoodCart, minusGoodCart, plusGoodCart } from '../redux/actions/cart'
...
function Cart() {
  ...
  const onClickRemove = (id) => {
    dispatch(removeGoodCart(id))
  }

  const onPlusItem = (id) => {
    dispatch(plusGoodCart(id))
  }

  const onMinusItem = (id) => {
    dispatch(minusGoodCart(id))
  }
          ...
          <div className="cart">
            ...
            <div className="cart__bottom">
              ...
              <div className="cart__bottom-buttons">
                ...
                <Link to="/">
                  <Button className="go-back-btn" addBtn outline>
                ...
                <Button onClick={cartOrder} className="pay-btn">
            ...
            <div className="cart cart--empty">
              ...
              <img src={emptyImg} alt="Пустая корзина" />
